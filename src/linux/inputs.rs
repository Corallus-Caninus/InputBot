...
//TODO: how can enums be overriden so I can PR the rest of this without such a mess.
...
pub fn scan_code_to_key(scan_code: u32) -> Option<KeybdKey> {
    match scan_code {
        ...
        98 => Some(MouseKeySlash),
        69 => Some(MouseKeyNumlock),

        // 900=>Some(MouseKeyUpperLeft),
        // 901=>Some(MouseKeyUp),
        // 902=>Some(MouseKeyUpperRight),
        // 903=>Some(MouseKeyHistoryForward),
        // 904=>Some(MouseKeyLeft),
        // 907=>Some(MouseKeyMiddle),
        // 906=>Some(MouseKeyRight),
        // 907=>Some(MouseKeyHistoryBack),
        // 908=>Some(MouseKeyLowerLeft),
        // 909=>Some(MouseKeyDown),
        // 910=>Some(MouseKeyLowerRight),
        // 911=>Some(MouseKeyFast),
        // 0xe01c=>Some(MouseKeySlow),
        // 912=>Some(MouseKeyClickToggle),
        // 914=>Some(MouseKeyActivate),
        // 915=>Some(MouseKeySlash),
        // 916=>Some(MouseKeyNumlock),
